...
test('ioverlap/2_valid_disjoint') :-
    ioverlap([[1, 4], [5, 8]], [[2, 3], [6, 7]]).     
test('ioverlap/2_valid_disjoint') :-
    ioverlap([[1, 4], [5, 8]], [[-4, -2], [6, 9]]).     
test('ioverlap/2_valid_disjoint') :-
    ioverlap([[1, 4], [5, 8]], [[-4, 2], [6, 7]]).
test('ioverlap/2_valid_disjoint') :-
    ioverlap([[neg_infinity, -4], [5, pos_infinity]], [[pos_infinity, pos_infinity]]).
test('ioverlap/2_valid_disjoint') :-
    ioverlap([[neg_infinity, -4], [5, pos_infinity]], [[neg_infinity, neg_infinity]]).
test('ioverlap/2_valid_disjoint') :-
    ioverlap([[neg_infinity, -4], [5, pos_infinity]], [[-4, 2], [6, 9]]).
test('ioverlap/2_valid_disjoint', fail) :-
    ioverlap([[neg_infinity, -4], [5, pos_infinity]], [2, 4]).
